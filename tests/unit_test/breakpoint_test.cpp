...
void DoBreakpointTest(std::vector<TestData> test_datas, int thread_num, bool enable_save_slice_to_tmp) {
    for (auto test_data : test_datas) {
        std::future<void> test_task = std::async(std::launch::async, [test_data, thread_num, enable_save_slice_to_tmp]() {
